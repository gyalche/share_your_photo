          ...
          <div className="relative flex flex-col mb-7">
            <div className="flex flex-col justify-center items-center">
              ...
              <img
                ...
                src={user.image} alt="userprofile"
              />
                  ...
                  <GoogleLogout
                    ...
                    render={(renderProps)=>(
                      <button type="button"
                        ...
                        >
                          <AiOutlineLogout color="red" fontSize={21}>Logout</AiOutlineLogout>
                        </button>
                    )}
            ...
            <div className="flex justify-center gap-5 items-center text-center mb-7">
                    <button
                      type="button"
                      onClick={(e)=>{
