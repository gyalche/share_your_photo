...
const Pin = ({pin:{postedBy, image, _id, destination, save}}) => {
    ...
    console.log(save)
    //since filter gives true or false
    //in order to get the length of save we wrap with "().length"
    // !! this is going to turn our statement return into boolean value
                                ...
                                {destination && (
                                    <a
                                        ...
                                        className="bg-white flex items-center gap-2 text-black
                                                    h-50 font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md
