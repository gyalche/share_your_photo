...
const PinDetail = ({user}) => {
  ...
  return (
    ...
    <div className="flex xl-flex-row flex-col m-auto bg-white " style={{maxWidth:'1000px', borderRadius:'32px'}}>
        <div className="flex justify-center items-center md:items-start flex-initial">
            <img src={pinDetails?.image && urlFor(pinDetails.image).url()}
                ...
                className="rounded-t-3xl rounded-lg" alt="user-post"
            />
        </div>
        <div className="w-full p-5 flex-1 xl:min-w-620px">
            <div className="flex items-center justify-between">
                <div className="flex gap-2 items-center">
                  <a href={`${pinDetails.image.asset.url}?dl=`}
                    ...
                    >
                      <MdDownloadForOffline className="m-2" />
                  </a>
                </div>
            ...
            <div className="max-h-370 overflow-y-auto">
              {pinDetails?.comment?.map((item, i)=>(
                <div className="flex gap-2 mt-5 bg-white items-center rounded-lg" key={i}>
                    <img 
            ...
            <div className="flex flex-wrap mt-6 gap-3">
                ...
                <input className="flex-1 border-gray-100 outline-none border-2 p-2 rounded-2xl focous:border-gray-300"
                      type="text"
                      value={comment}
    ...
    {pins?.length > 0? (
      ...
      <Spinner message="somebody will add more like this" />
    )}
    </>
  )
